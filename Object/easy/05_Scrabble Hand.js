function maximumScore(tileHand) {
    ...
    return Object.keys(tileHand).reduce((maximumScore,key)=>maximumScore+parseFloat(tileHand[key]||0),0);

    // return Object.keys(tileHand).reduce((a, b) => a + b, 0);

    // return Object.keys(tileHand)
